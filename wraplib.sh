...
if [ "$ARCH" = "x86" ]; then
    if [ ! -f "${CDIR}/scripts/write_gnu_wrappers.sh" ];  then
        ...
        echo "/*
 * Wrapper library for ${ARCH}
 * WARNING: EDIT AT YOUR OWN RISK!
 * WARNING: This file was automatically generated by:${__CMD}
 */"   > ${CDIR}/src/gnu_posix_interpose.c
        ${CDIR}/scripts/write_gnu_wrappers.sh ${CDIR}/arch/x86/include/posix_prototypes.h >> ${CDIR}/src/gnu_posix_interpose.c
        exit 0
    fi
fi
